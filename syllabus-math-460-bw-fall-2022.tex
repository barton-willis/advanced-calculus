...
\begin{alphalist}
   \item \emph{Exams will be given on  \textbf{Friday} of the week they are assigned.}
    ...
    \item The final exam will be given on \textbf{Wednesday December 14 from 8:00 \AM -- 10:00 \AM}.
...
\item For examinations, you make use a teacher provided quick reference sheet, 
