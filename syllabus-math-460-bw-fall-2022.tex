...
\begin{mypar}{0.25in}{0.25in} 
    ...
    \textbf{Exam 2} \dotfill  \printdate{28/10/\the\year} \\
    \textbf{Exam 3} \dotfill \printdate{2/12/\the\year} \\
      \textbf{Final exam} \dotfill  \printdate{14/12/\the\year} 8:00\AM -- 10:00 \AM
\end{mypar}
...
\wk    & \printdate{29/1/\the\year}   &  \S1.1 -- 1.3  & Sets, Functions, Real numbers, Completeness   & \hw  \\
...
\wk    & \printdate{19/9/\the\year}   &  \S2.3  & Bolzano-Weierstrass    &  \hw          \\
\wk    & \printdate{26/9/\the\year} &  \S2.5 -- \S2.6    &  Topology    & \textbf{\ex}  \\ \hline
\wk    & \printdate{3/10/\the\year}    & \S2.7   &   Topology  &    \hw  \\
\wk    & \printdate{10/10/\the\year}     & \S2.8 -- \S3.1  & Limits and Continuity & \hw \\
\wk    & \printdate{17/10/\the\year}   & \S3.1 -- \S3.2   & Limits and Continuity     & \hw   \\
\wk   &  \printdate{24/10/\the\year}   & \S3.3 -- \S3.4 & Monotone and Inverse Functions     & \hw \\ 
\wk   &  \printdate{31/10/\the\year}      &   \S3.5 & Derivatives   &  \textbf{\ex} \\ \hline
\wk   &  \printdate{7/11/\the\year}   &   \S41 -- \S4.2 &  Derivatives   & \hw  \\
\wk   & \printdate{14/11/\the\year}  & \S4.3    & Some Mean Value Theorems   &  \hw   \\
\wk   & \printdate{21/11/\the\year} & \S5.1 -- \S5.2  & The Riemann Integral    & \hw \\
\wk   & \printdate{28/11/\the\year}    &  \S5.3 -- \S5.4  & The Riemann Integral     &   \textbf{\ex}      \\
\wk   & \printdate{5/12/\the\year}   &       &  Catch up and Review     &   \hw \\ \hline
...
to look at the time is \emph{not} allowed.
