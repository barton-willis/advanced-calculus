...
\begin{equation*}
  \int {\left. \frac{{{\left( {{x}^{2}}-1\right) }^{\nicefrac{7}{2}}}}{{{x}^{3}}} \, \mathrm{d}x\right.}
  = \frac{\sqrt{{{x}^{2}}-1}\, \left( 6 {{x}^{6}}-32 {{x}^{4}}+116 {{x}^{2}}+15\right) +105 \operatorname{arcsin}\left( \frac{1}{x}\right)  {{x}^{2}}}{30 {{x}^{2}}}.
\end{equation*}
...
2. Euler substitution https://en.wikipedia.org/wiki/Euler_substitution 
