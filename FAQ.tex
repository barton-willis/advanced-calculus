...
\begin{flushleft}
  \large
\textbf{\Numberstringnum{58} Questions for Dr.\ Willis}
\end{flushleft}  
\normalsize
%\subsubsection*{FAQ}
\begin{enumerate}
...
On the printer options, the two hole punch is the first listed 
option, and the default option doesn't save correctly.
