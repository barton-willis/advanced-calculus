...
\begin{description}
    \item[(\emph{set bounded below})] A set $A$ is bounded below provided
        \((\exists M \in \reals)(\forall x \in A)(M < x) \).

    \item[(\emph{set bounded above})] The set $A$ is bounded above provided
        \((\exists M \in \reals)(\forall x \in A)(x < M ) \).   
        
    \item[(\emph{bounded set})] A set is bounded if it is bounded below and bounded above.
...
\begin{description}
    ...
    \begin{alphalist}
        ...
        \item such that for all $x \in \ball(a,\delta)$
